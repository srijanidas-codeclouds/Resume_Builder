...
const Template1 = ({ resumeData = {}, containerWidth }) => {
  ...
  const linkedin = typeof contactInfo.linkedin === "string" ? contactInfo.linkedin : "";
  const github = typeof contactInfo.github === "string" ? contactInfo.github : "";
  const website = typeof contactInfo.website === "string" ? contactInfo.website : "";
